...
{
    public class HomeViewModelService : IHomeViewModelServices      
    {
        ...
        public async Task<HomeViewModel> GetHomeViewModelAsync(int? categoryId, int? brandId, int pageId = 1)
        {
            ...
            var specProductsPaginated = new ProductsFilterSpecification(categoryId, brandId, (pageId - 1) * Constants.ITEM_PER_PAGE, Constants.ITEM_PER_PAGE);
